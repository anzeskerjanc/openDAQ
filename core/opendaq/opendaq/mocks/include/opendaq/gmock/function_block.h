...
struct MockGenericFunctionBlock : MockGenericSignalContainer<Class, TInterface>
{
    ...
    MOCK_METHOD(daq::ErrCode, getInputPorts, (daq::IList** port, daq::ISearchParams* searchParams), (override MOCK_CALL));
    MOCK_METHOD(daq::ErrCode, getSignals, (daq::IList** signals, daq::ISearchParams* searchParams), (override MOCK_CALL));
    ...
    MOCK_METHOD(daq::ErrCode, getFunctionBlocks, (daq::IList** functionBlocks, daq::ISearchParams* searchParams), (override MOCK_CALL));
