...
TEST_F(FunctionBlockWrapperTest, GetInputPorts)
{
    ...
    EXPECT_CALL(fb.mock(), getInputPorts(_, _)).WillRepeatedly(daq::GetOptionalExtraArg<daq::ListPtr<daq::IInputPort>, daq::SearchParamsPtr>{inputPorts});
...
TEST_F(FunctionBlockWrapperTest, GetSignals)
{
    ...
    EXPECT_CALL(fb.mock(), getSignals(_, _)).WillRepeatedly(daq::GetOptionalExtraArg<daq::ListPtr<daq::ISignal>, daq::SearchParamsPtr>{signals});
...
TEST_F(FunctionBlockWrapperTest, GetFunctionBlocks)
{
    ...
    fbs.pushBack(fb2);
    EXPECT_CALL(fb.mock(), getFunctionBlocks(_, _)).WillRepeatedly(daq::GetOptionalExtraArg<daq::ListPtr<daq::IFunctionBlock>, daq::SearchParamsPtr>{fbs});
