...
DECLARE_OPENDAQ_INTERFACE(IFolder, IComponent)
{
     ...
     *
     * If searchParams is not provided, the returned list contains only immediate children with visible set to `true`.
     */
    virtual ErrCode INTERFACE_FUNC getItems(IList** items, ISearchParams* searchParams = nullptr) = 0;
